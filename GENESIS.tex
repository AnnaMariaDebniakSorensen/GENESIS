...
\usepackage{enumitem} % For custom description/itemize/enumerate options
\usepackage{enumitem} % For description[leftmargin=...]
\usepackage{enumitem} % For description[leftmargin=...] support
\usepackage{enumitem}
\usepackage{parskip}
...
Rather than extending the Standard Model with new particles, GENESIS extends the geometry of spacetime itself. It unifies singularity resolution, dark matter, dark energy, and cosmic structure within a purely gravitational, spinor-coupled theory — and explicitly identifies what "exploded" at the Big Bang. GENESIS is not a ‘universe inside a black hole’ scenario, but rather a metric phase transition forming a causally independent spacetime.
\end{abstract}
...
\addcontentsline{toc}{subsection}{1.2 Notation and Units}
...
%=================== SECTION 4: DYNAMIC LAGRANGIAN AND TORSION FIELD EVOLUTION ===================
...
%=================== SECTION 5: TORUS AM IN THE BLACK HOLE CORE ===================
...
%=================== SECTION 6: PHASE SEQUENCE INSIDE THE BH ===================
...
% === rozdział 7:  Activation Mechanism ===
...
%=====SECTION 9: METRIC CHANGE AND METRIC RELAXATION ================
...
\begin{center}
  \fbox{%
    \begin{minipage}{0.92\linewidth}
      \small\textbf{Why this matters}\\begin{equation}\label{eq:auto118}
3pt]
...
%=================== SECTION 10: ASHTEKAR VARIABLES AND TORSION IN GENESIS ===================
...
%=================== SECTION 11: OBSERVATIONAL SIGNATURES ===================
...
\begin{figure}[h!]
\centering
%\includegraphics[width=0.72\textwidth]{Fig_TorsionCoreProfile.png}
